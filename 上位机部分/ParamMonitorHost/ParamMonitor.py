...
class ParamMonitor(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def setup_responsive_ui(self):
        ...
        for group_box in (self.ecgInfoGroupBox, self.spo2InfoGroupBox, self.respInfoGroupBox):
            ...
            shadow.setColor(QColor(34, 211, 238, 35))
        ...
        self.heartRateLabel.setStyleSheet("color: #22c55e;")
        self.labelSPO2Data.setStyleSheet("color: #22d3ee;")
        self.respRateLabel.setStyleSheet("color: #facc15;")
        ...
        self.titleWaveLabel.setStyleSheet(f"color: #e2e8f0; font-size: 32px; font-family: {mono_font_family}; font-weight: 900;")
        self.titleMetricLabel.setStyleSheet(f"color: #67e8f9; font-size: 32px; font-family: {zh_font_family}; font-weight: 900;")
    ...
    def create_wave_pixmaps(self):
        ...
        self.pixmapResp.fill(QColor("#000000"))
        ...
        self.pixmapSPO2.fill(QColor("#000000"))
        ...
        self.pixmapECG1.fill(QColor("#000000"))
    ...
    def _draw_wave_grid(self, painter, width, height):
        painter.setPen(QPen(QColor("#123524"), 1, Qt.SolidLine))
        for y in range(0, height, max(22, height // 6)):
            painter.drawLine(0, y, width, y)
        for x in range(0, width, 50):
            painter.drawLine(x, 0, x, height)
        painter.setPen(QPen(QColor("#1f6f45"), 1, Qt.SolidLine))
    ...
    def analyzeStatusData(self, data):
        ...
        if leadecg:
            ...
            self.labelecg_status.setStyleSheet("color: #86efac; border: 1px solid #166534; background-color: #052e16;")
        else:
            self.labelecg_status.setText("导联异常")
            self.labelecg_status.setStyleSheet("color: #fecaca; border: 1px solid #991b1b; background-color: #450a0a;")

        if leadresp:
            self.labelresp_status.setText("导联正常")
            self.labelresp_status.setStyleSheet("color: #86efac; border: 1px solid #166534; background-color: #052e16;")
        else:
            self.labelresp_status.setText("导联异常")
            self.labelresp_status.setStyleSheet("color: #fecaca; border: 1px solid #991b1b; background-color: #450a0a;")

        if leadspo2:
            self.labelspo2_status.setText("导联正常")
            self.labelspo2_status.setStyleSheet("color: #86efac; border: 1px solid #166534; background-color: #052e16;")
        else:
            self.labelspo2_status.setText("导联异常")
            self.labelspo2_status.setStyleSheet("color: #fecaca; border: 1px solid #991b1b; background-color: #450a0a;")
    ...
    def drawRespWave(self):
        ...
        self._draw_wave_grid(self.painterResp, self.maxRespLength, self.maxRespHeight)
        self.painterResp.setPen(QPen(QColor("#facc15"), 2, Qt.SolidLine))
    ...
    def drawSPO2Wave(self):
        ...
        self._draw_wave_grid(self.painterSPO2, self.maxSPO2Length, self.maxSPO2Height)
        self.painterSPO2.setPen(QPen(QColor("#22d3ee"), 2, Qt.SolidLine))
        for i in range(iCnt - 1):
    ...
    def drawECG1Wave(self):
        ...
        self._draw_wave_grid(self.painterEcg1, self.maxECG1Length, self.maxECG1Height)
        self.painterEcg1.setPen(QPen(QColor("#22c55e"), 2, Qt.SolidLine))
        for i in range(iCnt - 1):
